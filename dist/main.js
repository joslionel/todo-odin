...
/* harmony import */ var _node_modules_date_fns__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../node_modules/date-fns */ "./node_modules/date-fns/esm/formatDistance/index.js");
/* harmony import */ var _node_modules_date_fns__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../node_modules/date-fns */ "./node_modules/date-fns/esm/format/index.js");
    ...
    if (content == 'default') {
        ...
        if (content.projectTasks) {
            content.projectTasks.forEach(task => {
                const isTaskOverDue = () => {
                    if ((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), new Date(task[1])) == 1) {
                        return true
                    } else {
                        return false
                    }
                ...
                if (isTaskOverDue()) {
                    stepDueDate.textContent = `Task overdue by ${(0,_node_modules_date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), new Date(task[1]))}`
                } else {
                    stepDueDate.textContent = `Task due in ${(0,_node_modules_date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), new Date(task[1]))} on ${(0,_node_modules_date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(task[1]), 'EEE dd MMMM')}`;
                }
        ...
        ;(0,_projects_js__WEBPACK_IMPORTED_MODULE_0__.saveLocal)(project)
    }
...
/* harmony export */ });
/* harmony import */ var _node_modules_date_fns__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../node_modules/date-fns */ "./node_modules/date-fns/esm/format/index.js");
...
const project = (projectName, projectTasks, projectPriority, dueDate) => {
    ...
    const due = (dueDate) => {
        return (0,_node_modules_date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(dueDate, 'dd MM yyyy')
    }

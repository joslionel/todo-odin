...
/* harmony import */ var _node_modules_date_fns__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../node_modules/date-fns */ "./node_modules/date-fns/esm/format/index.js");
/* harmony import */ var _node_modules_date_fns__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../node_modules/date-fns */ "./node_modules/date-fns/esm/formatDistanceToNow/index.js");
    ...
    if (content == 'default') {
        ...
        if (content.projectTasks) {
            content.projectTasks.forEach(task => {
                ...
                let date = (0,_node_modules_date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(task[1]), 'eeee do LLLL')
                
                console.log(date)
                stepDueDate.textContent = `Task due in ${(0,_node_modules_date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(task[1]))} on ${date}`;
...
projects.push(project(
    'Default Prawbect',
    [
        ['Step 1', (0,_node_modules_date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), 'MM/dd/yyyy'), 'Notes about step 1'],
        ['Step 2', (0,_node_modules_date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), 'MM/dd/yyyy'), 'Notes about step 1'],
        ['Step 3', (0,_node_modules_date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), 'MM/dd/yyyy'), 'Notes about step 1'],
    ],
    1,
    '',
))
projects.push(project('Project 2', [['Task 1', (0,_node_modules_date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), 'MM/dd/yyyy'), 'Notes about step 1'], ['Task 2', (0,_node_modules_date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), 'MM/dd/yyyy'), 'Notes about step 1'], ['Task 3', (0,_node_modules_date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), 'MM/dd/yyyy'), 'Notes about step 1']], 0, ''))
...
const addTaskContent = () => {
    ...
    submitButton.addEventListener('click', function (e) {
        ...
        let date = (0,_node_modules_date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(taskDueDate.value), 'dd/MM/yyyy')
...
const submitNewTask = (task, duedate, notes) => {
    let date = (0,_node_modules_date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(duedate), 'dd/MM/yyyy')
